...
namespace SmartAgri.DataAccess.Migrations
{
    ...
    [Migration("20231206114054_mig_1")]
    partial class mig_1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartAgri.Entities.Concrete.AdvertBuy", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 12, 6, 14, 40, 54, 90, DateTimeKind.Local).AddTicks(4487),
                            ProductId = 1,
                            Quantity = 100,
                            StatusId = 1,
                            UnitPrice = 10m,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 12, 6, 14, 40, 54, 90, DateTimeKind.Local).AddTicks(4495),
                            ProductId = 1,
                            Quantity = 200,
                            StatusId = 1,
                            UnitPrice = 20m,
            ...
            modelBuilder.Entity("SmartAgri.Entities.Concrete.AdvertSell", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2023, 12, 6, 14, 40, 54, 90, DateTimeKind.Local).AddTicks(4504),
                            ProductId = 1,
                            Quantity = 300,
                            StatusId = 1,
                            UnitPrice = 30m,
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2023, 12, 6, 14, 40, 54, 90, DateTimeKind.Local).AddTicks(4505),
                            ProductId = 1,
                            Quantity = 400,
                            StatusId = 1,
                            UnitPrice = 40m,
